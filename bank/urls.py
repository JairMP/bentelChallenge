...
from .api import account_api_view, transaction_api_view, account_detail_api_view, transaction_detail_api_view
...
urlpatterns = [
    ...
    path('transaction/<str:transaction_id>/',
         transaction_detail_api_view, name='account_detail')
]
